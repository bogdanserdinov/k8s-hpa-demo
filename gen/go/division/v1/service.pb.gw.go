...
func request_DivisionService_Factorial_0(ctx context.Context, marshaler runtime.Marshaler, client DivisionServiceClient, req *http.Request, pathParams map[string]string) (proto.Message, runtime.ServerMetadata, error) {
...
func local_request_DivisionService_Factorial_0(ctx context.Context, marshaler runtime.Marshaler, server DivisionServiceServer, req *http.Request, pathParams map[string]string) (proto.Message, runtime.ServerMetadata, error) {
	var protoReq factorialpb.FactorialRequest
	var metadata runtime.ServerMetadata
...
func RegisterDivisionServiceHandlerServer(ctx context.Context, mux *runtime.ServeMux, server DivisionServiceServer) error {
	...
	mux.Handle("POST", pattern_DivisionService_Factorial_0, func(w http.ResponseWriter, req *http.Request, pathParams map[string]string) {
		ctx, cancel := context.WithCancel(req.Context())
		defer cancel()
		var stream runtime.ServerTransportStream
		ctx = grpc.NewContextWithServerTransportStream(ctx, &stream)
		...
		var err error
		var annotatedContext context.Context
		annotatedContext, err = runtime.AnnotateIncomingContext(ctx, mux, req, "/division.v1.DivisionService/Factorial", runtime.WithHTTPPathPattern("/api/division/v1/factorial"))
		if err != nil {
			runtime.HTTPError(ctx, mux, outboundMarshaler, w, req, err)
			return
		}
		resp, md, err := local_request_DivisionService_Factorial_0(annotatedContext, inboundMarshaler, server, req, pathParams)
		md.HeaderMD, md.TrailerMD = metadata.Join(md.HeaderMD, stream.Header()), metadata.Join(md.TrailerMD, stream.Trailer())
		annotatedContext = runtime.NewServerMetadataContext(annotatedContext, md)
		if err != nil {
			runtime.HTTPError(annotatedContext, mux, outboundMarshaler, w, req, err)
		...
		forward_DivisionService_Factorial_0(annotatedContext, mux, outboundMarshaler, w, req, resp, mux.GetForwardResponseOptions()...)
...
func RegisterDivisionServiceHandlerClient(ctx context.Context, mux *runtime.ServeMux, client DivisionServiceClient) error {
	...
	mux.Handle("POST", pattern_DivisionService_Factorial_0, func(w http.ResponseWriter, req *http.Request, pathParams map[string]string) {
		...
		var err error
		var annotatedContext context.Context
		annotatedContext, err = runtime.AnnotateContext(ctx, mux, req, "/division.v1.DivisionService/Factorial", runtime.WithHTTPPathPattern("/api/division/v1/factorial"))
		if err != nil {
			runtime.HTTPError(ctx, mux, outboundMarshaler, w, req, err)
			return
		}
		resp, md, err := request_DivisionService_Factorial_0(annotatedContext, inboundMarshaler, client, req, pathParams)
		annotatedContext = runtime.NewServerMetadataContext(annotatedContext, md)
		if err != nil {
			runtime.HTTPError(annotatedContext, mux, outboundMarshaler, w, req, err)
			return
...
var (
	...
	pattern_DivisionService_Factorial_0 = runtime.MustPattern(runtime.NewPattern(1, []int{2, 0, 2, 1, 2, 2, 2, 3}, []string{"api", "division", "v1", "factorial"}, ""))
)

var (
	forward_DivisionService_Divide_0 = runtime.ForwardResponseMessage

	forward_DivisionService_Factorial_0 = runtime.ForwardResponseMessage
)
